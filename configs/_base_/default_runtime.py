...
# enable_wandb = True
enable_wandb = False
# wandb_project = "weake2e-diff"  # custom your project name e.g. Sonata, PTv3 ## diffusion
# wandb_project = "weake2e-pointset"  # custom your project name e.g. Sonata, PTv3 ## diffusion
